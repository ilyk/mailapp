...
echo "🧪 Testing DBus Single-Instance Behavior"
echo "========================================"
echo ""
...
cargo run --bin simple-dbus-test &
FIRST_PID=$!
...
echo ""
echo "📝 Manual testing:"
echo "1. Run: cargo run --bin simple-dbus-test"
echo "2. Try closing window with X button (should hide)"
echo "3. Use Exit menu to quit"
echo "4. Test DBus: dbus-send --session --dest=com.asgard.MailApp --type=method_call --print-reply /com/asgard/Mail com.asgard.Mail.ShowWindow"
